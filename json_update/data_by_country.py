...
# override old values
json_countries['data']['countries'][0]['confirmed'] = int(
    confirmed_cases_algeria)
json_countries['data']['countries'][1]['confirmed'] = int(
    confirmed_cases_tunisia)
json_countries['data']['countries'][2]['confirmed'] = int(
    confirmed_cases_egypt)
json_countries['data']['countries'][3]['confirmed'] = int(
    confirmed_cases_mauritania)
json_countries['data']['countries'][4]['confirmed'] = int(
    confirmed_cases_libya)
...
# override old values
json_countries['data']['countries'][0]['recovered'] = int(
    recovered_cases_algeria)
json_countries['data']['countries'][1]['recovered'] = int(
    recovered_cases_tunisia)
json_countries['data']['countries'][2]['recovered'] = int(
    recovered_cases_egypt)
json_countries['data']['countries'][3]['recovered'] = int(
    recovered_cases_mauritania)
json_countries['data']['countries'][4]['recovered'] = int(
    recovered_cases_libya)

# create and write json output file
f = open("output.json", "w")
json_countries = json.dump(json_countries, f, indent=4,
